    ...
    <nav className={`fixed top-0 left-0 right-0 z-50 transition-all duration-500 ${scrolled ? "bg-[oklch(0.12_0.015_260/95%)] backdrop-blur-xl border-b border-white/5 shadow-2xl" : "bg-transparent"}`}>
      <div className="container mx-auto flex items-center justify-between h-16 md:h-20">
        <a href="#" className="flex items-center gap-3 group">
          <div className="w-9 h-9 rounded-lg bg-gradient-to-br from-emerald-400 to-green-600 flex items-center justify-center text-white font-bold text-lg shadow-lg glow-green-sm group-hover:scale-110 transition-transform">M</div>
          <div>
            <span className="font-bold text-lg text-white tracking-tight">Manna Digital Hub</span>
            <span className="hidden sm:block text-[10px] text-emerald-400/80 tracking-widest uppercase -mt-0.5">AI Automation</span>
          </div>
        </a>
        ...
        <div className="hidden lg:flex items-center gap-3">
          {isAuthenticated ? (
            <Button onClick={() => setLocation("/admin")} className="bg-gradient-to-r from-emerald-500 to-green-600 hover:from-emerald-400 hover:to-green-500 text-white shadow-lg glow-green-sm">
            ...
            <>
              <a href="https://wa.me/27734061526?text=Hi%2C%20I%20want%20to%20automate%20my%20business" target="_blank" rel="noopener noreferrer">
                <Button variant="outline" className="border-emerald-500/30 text-emerald-400 hover:bg-emerald-500/10 hover:border-emerald-400/50">
                  <MessageCircle className="w-4 h-4 mr-2" /> WhatsApp Us
                </Button>
              </a>
              <a href="#contact">
                <Button className="bg-gradient-to-r from-emerald-500 to-green-600 hover:from-emerald-400 hover:to-green-500 text-white shadow-lg glow-green-sm">
        ...
        <div className="lg:hidden bg-[oklch(0.14_0.015_260/98%)] backdrop-blur-xl border-t border-white/5 pb-6">
          <div className="container mx-auto flex flex-col gap-1 pt-4">
            ...
            <div className="flex flex-col gap-2 mt-4 px-4">
              ...
              <a href="#contact">
                <Button className="w-full bg-gradient-to-r from-emerald-500 to-green-600 text-white">
                  Get Started <ArrowRight className="w-4 h-4 ml-1" />
                </Button>
              </a>
            </div>
  ...
  return (
    <section className="relative min-h-screen flex items-center overflow-hidden pt-20">
      ...
      <div className="absolute inset-0 bg-[oklch(0.1_0.02_260)]">
        ...
        <div className="absolute bottom-1/4 right-1/4 w-80 h-80 bg-green-500/8 rounded-full blur-[100px] animate-float" style={{ animationDelay: "3s" }} />
        <div className="absolute top-1/2 left-1/2 w-64 h-64 bg-emerald-400/5 rounded-full blur-[80px] animate-float" style={{ animationDelay: "1.5s" }} />
        {/* Grid pattern */}
      ...
      <div className="container mx-auto relative z-10">
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          <div className="space-y-8">
            {/* Badge */}
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full glass text-sm text-emerald-400">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <a href="https://wa.me/27734061526?text=Hi%2C%20I%20want%20a%20free%20discovery%20call" target="_blank" rel="noopener noreferrer">
                <Button size="lg" className="w-full sm:w-auto bg-gradient-to-r from-emerald-500 to-green-600 hover:from-emerald-400 hover:to-green-500 text-white text-lg px-8 py-6 shadow-xl glow-green">
          ...
          <div className="relative">
            <div className="relative glass rounded-2xl p-6 space-y-4 glow-green">
              ...
              <div className="space-y-3">
                {[
                  { icon: MessageCircle, text: "WhatsApp bot responding to leads", color: "text-green-400" },
                  { icon: Bot, text: "AI chatbot capturing enquiries", color: "text-emerald-400" },
                  { icon: TrendingUp, text: "Follow-up sequences running", color: "text-teal-400" },
                  ...
                  <div key={i} className="flex items-center gap-3 p-3 rounded-xl bg-white/5 hover:bg-white/8 transition-colors group">
                    ...
                    <span className="text-slate-300 text-sm group-hover:text-white transition-colors">{item.text}</span>
              ...
              {/* Mini chat preview */}
              <div className="mt-4 p-4 rounded-xl bg-gradient-to-br from-emerald-900/30 to-green-900/20 border border-emerald-500/10">
                ...
                <div className="space-y-2 text-sm">
                  ...
                  <div className="bg-emerald-500/20 rounded-lg rounded-br-none px-3 py-2 text-emerald-200 max-w-[80%] ml-auto">
            ...
            {/* Floating badges */}
            <div className="absolute -top-4 -right-4 px-3 py-1.5 rounded-full bg-emerald-500 text-white text-xs font-bold shadow-lg glow-green-sm animate-float">
              AI Powered
            </div>
          </div>
        </div>
      ...
      {/* Scrolling ticker */}
      <div className="absolute bottom-0 left-0 right-0 py-4 bg-gradient-to-r from-emerald-900/20 via-green-900/10 to-emerald-900/20 border-t border-b border-white/5 overflow-hidden">
        <div className="animate-marquee flex whitespace-nowrap">
          {["WhatsApp Automation", "AI Chatbots", "Lead Follow-Up", "24/7 Response", "South Africa", "Nigeria", "Kenya", "Ghana", "Garden Route", "George", "Cape Town", "POPIA Compliant", "Stop Losing Leads", "WhatsApp Automation", "AI Chatbots", "Lead Follow-Up", "24/7 Response", "South Africa", "Nigeria", "Kenya", "Ghana", "Garden Route", "George", "Cape Town", "POPIA Compliant", "Stop Losing Leads"].map((t, i) => (
    ...
    <section className="relative py-24 bg-[oklch(0.08_0.02_260)]">
      <div className="container mx-auto">
        ...
        <div className="grid md:grid-cols-3 gap-6">
          {problems.map((p, i) => (
            <Card key={i} className="bg-white/[0.03] border-white/5 hover:border-emerald-500/20 transition-all duration-500 group hover:-translate-y-1">
...
function ServicesSection() {
  ...
  return (
    <section id="services" className="relative py-24 bg-[oklch(0.12_0.015_260)]">
      <div className="container mx-auto">
        <div className="text-center mb-16">
          <span className="text-sm text-emerald-400 font-medium uppercase tracking-wider">Our Services</span>
          <h2 className="text-4xl sm:text-5xl font-bold text-white mt-4">
        ...
        <div className="grid lg:grid-cols-3 gap-6 mb-12">
          {services.map((s, i) => (
            <Card key={i} className={`relative bg-white/[0.03] border-white/5 hover:border-emerald-500/20 transition-all duration-500 group hover:-translate-y-2 ${s.popular ? "ring-1 ring-emerald-500/30" : ""}`}>
              {s.popular && (
                <div className="absolute -top-3 left-1/2 -translate-x-1/2 px-4 py-1 bg-gradient-to-r from-emerald-500 to-green-600 text-white text-xs font-bold rounded-full shadow-lg">
                  Most Popular
                </div>
              )}
              <CardContent className="p-8">
                <div className="flex items-center gap-3 mb-6">
                  <span className="text-emerald-500/40 text-sm font-mono">{s.num}</span>
                  <div className="w-12 h-12 rounded-xl bg-gradient-to-br from-emerald-500/20 to-green-600/10 flex items-center justify-center">
                    <s.icon className="w-6 h-6 text-emerald-400" />
                  </div>
                </div>
                <h3 className="text-2xl font-bold text-white mb-4 group-hover:text-emerald-400 transition-colors">{s.title}</h3>
                ...
                <div className="space-y-2 pt-4 border-t border-white/5">
                  ...
                  <div className="flex justify-between text-sm">
                    ...
                    <span className="text-emerald-400 font-semibold">{s.monthly}</span>
                  </div>
                </div>
              </CardContent>
            </Card>
        ...
        {/* Bundle card */}
        <Card className="bg-gradient-to-r from-emerald-900/30 to-green-900/20 border-emerald-500/20 glow-green">
          <CardContent className="p-8 sm:p-12">
            <div className="flex flex-col lg:flex-row items-center gap-8">
              <div className="flex-1">
                <div className="flex items-center gap-2 mb-4">
                  <Sparkles className="w-5 h-5 text-emerald-400" />
                  <span className="text-emerald-400 font-semibold text-sm uppercase tracking-wider">The Complete AI Starter Pack</span>
                </div>
                <h3 className="text-3xl font-bold text-white mb-4">All three services bundled together</h3>
                <p className="text-slate-300 text-lg">WhatsApp automation, website chatbot, and lead follow-up. One setup, one monthly fee, complete coverage. Perfect for businesses serious about growth.</p>
              </div>
              <div className="text-center lg:text-right shrink-0">
                <div className="text-4xl font-bold text-white">R8,000</div>
                <div className="text-emerald-400 text-lg">setup + R2,500/month</div>
                <a href="https://wa.me/27734061526?text=Hi%2C%20I%27m%20interested%20in%20the%20AI%20Complete%20package" target="_blank" rel="noopener noreferrer">
                  <Button size="lg" className="mt-4 bg-gradient-to-r from-emerald-500 to-green-600 text-white shadow-lg">
...
function HowItWorksSection() {
  const steps = [
    ...
    { num: "02", icon: Zap, title: "We Build It", desc: "Our team configures your automation flows, trains your AI on your business, and sets everything up. You don't touch a thing.", color: "from-emerald-500/20 to-green-500/10" },
  ...
  return (
    <section id="how" className="relative py-24 bg-[oklch(0.08_0.02_260)]">
      <div className="container mx-auto">
        <div className="text-center mb-16">
          <span className="text-sm text-emerald-400 font-medium uppercase tracking-wider">How It Works</span>
          <h2 className="text-4xl sm:text-5xl font-bold text-white mt-4">
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {steps.map((s, i) => (
            <div key={i} className="relative group">
              <Card className="bg-white/[0.03] border-white/5 hover:border-emerald-500/20 transition-all duration-500 h-full hover:-translate-y-1">
                <CardContent className="p-8">
                  <div className={`w-14 h-14 rounded-2xl bg-gradient-to-br ${s.color} flex items-center justify-center mb-6`}>
                    <s.icon className="w-7 h-7 text-white" />
                  </div>
                  <span className="text-emerald-500/40 text-xs font-mono">{s.num}</span>
                  <h3 className="text-xl font-bold text-white mt-2 mb-3 group-hover:text-emerald-400 transition-colors">{s.title}</h3>
...
function IndustriesSection() {
  ...
  return (
    <section id="who" className="relative py-24 bg-[oklch(0.12_0.015_260)]">
      <div className="container mx-auto">
        <div className="text-center mb-16">
          <span className="text-sm text-emerald-400 font-medium uppercase tracking-wider">Who We Serve</span>
          <h2 className="text-4xl sm:text-5xl font-bold text-white mt-4">
          ...
          {industries.map((ind, i) => (
            <Card key={i} className="bg-white/[0.03] border-white/5 hover:border-emerald-500/20 transition-all duration-500 group hover:-translate-y-1">
              <CardContent className="p-6">
                ...
                <h3 className="text-lg font-bold text-white mb-2 group-hover:text-emerald-400 transition-colors">{ind.title}</h3>
...
function StatsSection() {
  return (
    <section className="relative py-24 bg-[oklch(0.08_0.02_260)]">
      <div className="container mx-auto">
        <div className="text-center mb-16">
          <span className="text-sm text-emerald-400 font-medium uppercase tracking-wider">Why It Works</span>
          <h2 className="text-4xl sm:text-5xl font-bold text-white mt-4">
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {[
            { value: "9×", label: "Higher lead conversion with instant response", color: "from-emerald-500 to-green-600" },
...
function PricingSection() {
  ...
  return (
    <section id="pricing" className="relative py-24 bg-[oklch(0.12_0.015_260)]">
      <div className="container mx-auto">
        <div className="text-center mb-16">
          <span className="text-sm text-emerald-400 font-medium uppercase tracking-wider">Pricing</span>
          <h2 className="text-4xl sm:text-5xl font-bold text-white mt-4">
            Enterprise-quality AI<br />
            <span className="text-gradient-green">at SME prices.</span>
          </h2>
          <p className="text-slate-400 mt-4 max-w-2xl mx-auto text-lg">
        ...
        <div className="grid lg:grid-cols-3 gap-6">
          {plans.map((p, i) => (
            <Card key={i} className={`relative bg-white/[0.03] border-white/5 transition-all duration-500 hover:-translate-y-2 ${p.popular ? "ring-2 ring-emerald-500/40 glow-green" : ""}`}>
              {p.popular && (
                <div className="absolute -top-3 left-1/2 -translate-x-1/2 px-4 py-1 bg-gradient-to-r from-emerald-500 to-green-600 text-white text-xs font-bold rounded-full shadow-lg">
                  Most Popular
                </div>
              ...
              <CardContent className="p-8 flex flex-col h-full">
                ...
                <div className="mb-6">
                  ...
                  <div className="text-sm text-slate-500 mt-1">
                    Then <span className="text-emerald-400 font-semibold">{p.monthly}</span>/month
                  </div>
                </div>
    ...
    <section id="about" className="relative py-24 bg-[oklch(0.08_0.02_260)]">
      <div className="container mx-auto">
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          <div>
            <span className="text-sm text-emerald-400 font-medium uppercase tracking-wider">About Us</span>
            ...
            <div className="space-y-6">
              {[
                ...
                { icon: Shield, title: "Accessible pricing", desc: "Enterprise-quality AI at SME prices. No massive upfront costs, no lock-in contracts longer than month-to-month." },
                ...
                <div key={i} className="flex gap-4">
                  <div className="w-12 h-12 rounded-xl bg-gradient-to-br from-emerald-500/20 to-green-600/10 flex items-center justify-center shrink-0">
          ...
          {/* SA flag/pride card */}
          <div className="relative">
            <Card className="bg-gradient-to-br from-emerald-900/20 to-green-900/10 border-emerald-500/10 overflow-hidden">
...
function CTASection() {
  return (
    <section id="contact" className="relative py-24 bg-[oklch(0.12_0.015_260)]">
      <div className="container mx-auto">
        <Card className="bg-gradient-to-br from-emerald-900/30 via-green-900/20 to-emerald-900/10 border-emerald-500/20 glow-green overflow-hidden relative">
          ...
          <CardContent className="p-10 sm:p-16 relative z-10">
            <div className="text-center max-w-3xl mx-auto">
              <span className="text-sm text-emerald-400 font-medium uppercase tracking-wider">Ready to Start?</span>
              <h2 className="text-4xl sm:text-5xl font-bold text-white mt-4 mb-6">
              ...
              <div className="flex flex-wrap justify-center gap-3 mb-10">
                {["Free discovery call", "No obligation", "Live in 48 hours", "Month-to-month"].map((t, i) => (
                  <span key={i} className="flex items-center gap-2 px-4 py-2 rounded-full bg-white/5 text-sm text-slate-300">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                <a href="https://wa.me/27734061526?text=Hi%2C%20I%20want%20a%20free%20discovery%20call" target="_blank" rel="noopener noreferrer">
                  <Button size="lg" className="w-full sm:w-auto bg-gradient-to-r from-emerald-500 to-green-600 hover:from-emerald-400 hover:to-green-500 text-white text-lg px-10 py-6 shadow-xl glow-green">
    ...
    <section id="payment" className="relative py-24 bg-[oklch(0.08_0.02_260)]">
      <div className="container mx-auto max-w-2xl">
        <div className="text-center mb-12">
          <span className="text-sm text-emerald-400 font-medium uppercase tracking-wider">Payment</span>
        ...
        <Card className="bg-white/[0.03] border-white/5">
          <CardContent className="p-8">
            ...
            <p className="text-sm text-slate-500 mt-6">
              Use your name or business name as reference. Send proof of payment to <a href="mailto:info@mannadigitalhub.co.za" className="text-emerald-400 hover:underline">info@mannadigitalhub.co.za</a>
            </p>
          </CardContent>
        </Card>
      </div>
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-10 mb-12">
          ...
          <div className="sm:col-span-2 lg:col-span-1">
            <div className="flex items-center gap-3 mb-4">
              <div className="w-9 h-9 rounded-lg bg-gradient-to-br from-emerald-400 to-green-600 flex items-center justify-center text-white font-bold text-lg">M</div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-slate-400">
              <li><a href="#services" className="hover:text-emerald-400 transition-colors">WhatsApp Automation</a></li>
              <li><a href="#services" className="hover:text-emerald-400 transition-colors">AI Website Chatbot</a></li>
              <li><a href="#services" className="hover:text-emerald-400 transition-colors">Lead Follow-Up</a></li>
              <li><a href="#services" className="hover:text-emerald-400 transition-colors">AI Complete Bundle</a></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm text-slate-400">
              <li className="flex items-center gap-2">
                ...
                <a href="tel:+27734061526" className="hover:text-emerald-400 transition-colors">+27 73 406 1526</a>
              </li>
              <li className="flex items-center gap-2">
                <Mail className="w-4 h-4 text-emerald-500" />
                <a href="mailto:info@mannadigitalhub.co.za" className="hover:text-emerald-400 transition-colors">info@mannadigitalhub.co.za</a>
              </li>
              <li className="flex items-center gap-2">
                <MessageCircle className="w-4 h-4 text-emerald-500" />
                <a href="https://wa.me/27734061526" target="_blank" rel="noopener noreferrer" className="hover:text-emerald-400 transition-colors">WhatsApp Us</a>
              </li>
            </ul>
          </div>
        </div>
